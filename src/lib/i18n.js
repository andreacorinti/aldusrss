...
const STRINGS = {
  it: {
    ...
    feedUrlPlaceholder: "https://esempio.it/feed.xml",
    weightLow: "Basso",
    ...
    sectionsVisibleSubtitle: "Nascondi le sezioni che non ti interessano",
  ...
  en: {
    ...
    sectionsVisibleSubtitle: "Hide the sections you're not interested in",
