...
const STRINGS = {
  it: {
    ...
    sectionsVisibleSubtitle: "Nascondi le sezioni che non ti interessano, trascinale per riordinarle",
  ...
  en: {
    ...
    sectionsVisibleSubtitle: "Hide sections you're not interested in, drag them to reorder",
