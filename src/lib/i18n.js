...
const STRINGS = {
  it: {
    ...
    feedsSubtitle: 'Ogni fonte alimenta le sezioni del tuo giornale. Alza il peso di una fonte per farla comparire più spesso in evidenza (in cima, con foto) in "Prima Pagina".',
  ...
  en: {
    ...
    feedsSubtitle: 'Each source feeds your paper\'s sections. Raise a source\'s weight to make it show up more often front and center (with a photo) on "Front Page".',
