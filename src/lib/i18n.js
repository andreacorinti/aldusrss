...
const STRINGS = {
  it: {
    ...
    betaTestersLine: "Grazie a chi sta provando l'app: Alessandro Portillo, Annalisa Meloni, Antonio Policastro, Bianca Curtrono, Efi Zochiou, Jovan Begovic, Marco Cecchi, Patrizia Paredi — e Claude, che fa tutto il lavoro.",
  ...
  en: {
    ...
    betaTestersLine: "Thanks to everyone testing the app: Alessandro Portillo, Annalisa Meloni, Antonio Policastro, Bianca Curtrono, Efi Zochiou, Jovan Begovic, Marco Cecchi, Patrizia Paredi — and Claude, who does all the actual work.",
